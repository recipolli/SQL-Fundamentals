...
namespace CustomerDataAdapter {
    ...
    public partial class CustomerData : global::System.Data.DataSet {
        ...
        public partial class CustomerTableDataTable : global::System.Data.TypedTableBase<CustomerTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomerTableRow AddCustomerTableRow(string FirstName, string LastName) {
...
namespace CustomerDataAdapter.CustomerDataTableAdapters {
    ...
    public partial class CustomerTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[CustomerTable] WHERE (([Id] = @Original_Id) AND ([FirstName] =" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[CustomerTable] ([FirstName], [LastName]) VALUES (@FirstName, @" +
                "LastName);\r\nSELECT Id, FirstName, LastName FROM CustomerTable WHERE (Id = SCOPE_" +
                "IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[CustomerTable] SET [FirstName] = @FirstName, [LastName] = @LastName WHERE (([Id] = @Original_Id) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName));
SELECT Id, FirstName, LastName FROM CustomerTable WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CustomerDataAdapter.Properties.Settings.Default.CustomerDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName FROM dbo.CustomerTable";
        ...
        public virtual int Fill(CustomerData.CustomerTableDataTable dataTable) {
        ...
        public virtual CustomerData.CustomerTableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CustomerData.CustomerTableDataTable dataTable = new CustomerData.CustomerTableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CustomerData.CustomerTableDataTable dataTable) {
